...
Phase 1 of a mobile-first professional profile and directory network for Indian sport. It includes a landing page, Firebase anonymous sign-in, role-based onboarding, and an editable profile summary.
...
3. In Firebase Authentication, enable **Anonymous** as a sign-in provider. Add `localhost` to Authorized domains for local development. Members enter a phone number in their profile during this interim authentication mode; it is not OTP-verified.
